...
(function($){
	...
	var plugin = $.fn.tooltip;
	$.fn.tooltip = function(options, param){
		var result;
		if (typeof options != 'string'){
			options = options || {};
			result = plugin.call(this, $.extend({}, options, {
				onShow:function(e){
			...
			result = plugin.call(this, options, param);
		}
		return result;
	};
	$.fn.tooltip.defaults = plugin.defaults;
	$.fn.tooltip.parseOptions = plugin.parseOptions;
	$.fn.tooltip.methods = plugin.methods;
