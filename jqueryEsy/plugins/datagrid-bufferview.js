...
var bufferview = $.extend({}, $.fn.datagrid.defaults.view, {
	...
	onBeforeRender: function(target){
		...
		function scrolling() {		    
		    ...
		    var mov =dc.body2.scrollLeft();
		    if ((mov == 0) && (sessionStorage.getItem('scrollv')=="No"))
		    {
		        if (dc.body2.scrollTop() >= getDataHeight() - dc.body2.height()) {
		            this.getRows.call(this, target, function (rows) {
		                this.rows = rows;
		                this.populate.call(this, target);
		            });
		    ...
		    else { sessionStorage.setItem('scrollv', 'Si'); }
		}
