<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListarCatalogos.aspx.cs" Inherits="FILE_PagosEspeciales_ListarCatalogos" %>

<%    
    string strtipo = Request.QueryString["strtipo"].ToString();   
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_CapturaEspecial_ListarCatalogos @tipotbl=" + strtipo + ", @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @valor='" + busqueda + "'");
