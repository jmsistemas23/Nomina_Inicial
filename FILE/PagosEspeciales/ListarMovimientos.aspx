<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListarMovimientos.aspx.cs" Inherits="FILE_PagosEspeciales_ListarMovimientos" %>
...
<%       
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_CapturaEspecial_ListarMovimientos @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @valor='" + busqueda + "',@multi='"+multi+"'");
