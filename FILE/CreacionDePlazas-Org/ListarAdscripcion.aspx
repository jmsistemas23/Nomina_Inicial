<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListarAdscripcion.aspx.cs" Inherits="FILE_CreacionDePlazas_Org_ListarAdscripcion" %>
...
<%
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SP_SelectParaPaginacionDeAdscripcion @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @busqueda='" + busqueda + "'");
    ...
    objAdscripciones.total = ds.Tables[1].Rows[0][0].ToString();
