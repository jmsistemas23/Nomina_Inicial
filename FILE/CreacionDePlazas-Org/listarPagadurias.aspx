...
<%
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SP_SelectParaPaginacionDePagadurias @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @busqueda='" + busqueda + "'");
    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
    {
        ...
        zonpag.Localidad = ds.Tables[0].Rows[i]["municipio"].ToString().Trim(); 
        lstPagaduria.Add(zonpag);
    }
    objPagaduria.rows = lstPagaduria;
    objPagaduria.total = ds.Tables[1].Rows[0][0].ToString();;
