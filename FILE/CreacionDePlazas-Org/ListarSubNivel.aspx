<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListarSubNivel.aspx.cs" Inherits="FILE_CreacionDePlazas_Org_ListarSubNivel" %>
...
<%
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SP_SelectParaPaginacionDeSubNivel @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @busqueda='" + busqueda + "'");
