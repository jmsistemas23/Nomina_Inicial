...
$(document).ready(function () {
   ...
   var tabla = $_GET('btbl');
    ...
    $('#btnNuevaCap').bind('click', function () { CAPTURA_NUEVA('#btnNuevaCap'); });
        ...
        $('#btnLModificarCap').bind('click', function () {          
            LIMPIAR_CAPTURA("tblo", "objcamposO", "banO");
        });
        ...
        $('#btnLNuevaCap').bind('click', function () {            
...
function CAPTURA_NUEVA(btnobj) {
    ...
    {
        tipmov = "G"; VALIDAR_MULTINOMINA('NC');
    }
}
                                    ...
                                    onSelect: function (rec) {
                                        if (rec.valor.toLowerCase() != "x") {
                                            if (rec.relacion != "") {
                                                ...
                                                if (camposfiltro != "") {
                                                    for (var j = 0; j < camposfiltro.length; j++) {
                                                        if (rec.ddlobj == camposfiltro[j])
                                                        { rquery = rquery.replace("@" + camposfiltro[j], "'" + rec.valor + "'"); }
            ...
            if (data.d[0] != "") {
                ...
                for (var col = 0; col < columnas.length; col++) {
                    datos = columnas[col].split(',');                  
                        ...
                        columns.push({ "field": valor, "title": titulo, "width": ancho, "align": alinear,"hidden":visible });                    
                }
            ...
            var control = configuracion[i].split('/');            
                ...
                for (var j = 0; j < campos.length; j++) {
                    ...
                    if ((tipodato == "e")  || (tipodato == "n")){
                        ...
                        { $('#' + campos[j]).numberbox('setValue', valor); }
                    }
        ...
        success: function (data) {
            if (data.d[0] == "1") {
                ...
                if (tipmov=='G')
                {
                    ...
                    document.getElementById('lblnivel2').innerHTML = "Documento = " + cvedoc;
                    $('#dmoddoc').hide();
                ...
                if (obj.length > 0) {
                    ...
                    if (cvedoc != "") { sessionStorage.setItem('ctrltblo', obj); }
            ...
            if (origen == false) {
                ...
                if (tipodato == "s") {
                    ...
                    if (((valor.toUpperCase() == "X") || (valor == "")) && (nulo == 1)) { $.messager.alert('Información', 'Falta el valor ' + objcampos[i].Descripcion, 'info'); sessionStorage.setItem(ban, true); return 0; }
                        ...
                        if (((valor.toUpperCase() == "X") || (valor == "")) && (nulo == 0))
            ...
            if (origen == false) {
                ...
                if ((tipodato == "n") || (tipodato == "e"))  {
                    if (valorpredeterminado != "")
                      { $('#' + campos).numberbox('setValue', valorpredeterminado); }
                    else
