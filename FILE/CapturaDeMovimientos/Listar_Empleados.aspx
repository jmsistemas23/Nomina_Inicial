<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar_Empleados.aspx.cs" Inherits="FILE_CapturaDeMovimientos_Listar_Empleados" %>
...
<%
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Sistemas_DatosGrid @tabla='" + tabla + "',@tipo='"+tipo+"', @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @condicion='" + busqueda + "'");
