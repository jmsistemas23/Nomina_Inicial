...
public partial class FILE_CapturaDeMovimientos_Funciones : System.Web.UI.Page
{
    ...
    public static string[] Listar_MovimientosPermisos(string strtipo, string strclave)
    {
        ...
        DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Sistemas_ListarMovimientosPermisos 1,'" + strtipo + "','" + strclave + "'");
    ...
    public static string[] Guardar_Captura(string tipmov,string strtipo,  string strmov, string strcamposO,string strcamposD,string strcamposS,string condicion,string multi)
    {
        ...
        string[] result = { "", "","" };        
        Utilerias lib = new Utilerias();
        DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Capturas_GuardarMovimientos '" + tipmov + "','" + strtipo + "','"+objusuario.Usuario+"','" + strmov + "','" + strcamposO + "','" + strcamposD + "','" + strcamposS + "','" + condicion + "','" + multi + "'");
        //DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Capturas_GuardarMovimientos '" + tipmov + "','" + strtipo + "','Admin','" + strmov + "','" + strcamposO + "','" + strcamposD + "','" + strcamposS + "','" + condicion + "','" + multi + "'");
