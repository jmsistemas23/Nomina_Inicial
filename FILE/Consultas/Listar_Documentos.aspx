<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar_Documentos.aspx.cs" Inherits="FILE_Consultas_Plazas_Listar_Documentos" %>
...
<%
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Catalogos_DatosGrid @tabla='" + tabla + "', @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @condicion='" + busqueda + "',@multi=''");
