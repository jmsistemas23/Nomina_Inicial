<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar_PagosEspeciales.aspx.cs" Inherits="FILE_Consultas_Listar_PagosEspeciales" %>
...
<%           
    ...
    string quin = Request.QueryString["quin"].ToString();  
    int paginasN = Convert.ToInt32(pagina);
    int rowsN = Convert.ToInt32(rows);
    Utilerias lib = new Utilerias();

    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Consulta_BuscarPlazasEspeciales @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @valor='" + busqueda + "',@quin='"+quin+"'");
