<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Consulta_Capturas.aspx.cs" Inherits="FILE_Consultas_Consulta_Capturas" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="Consulta_Capturas.js?1.1"></script>  
</head>
<body>
    <form id="form1" runat="server">
     <div class="easyui-layout" style="width:100%;height:100%; overflow:hidden;" align="center"> 
         <div id="dlista" class="easyui-layout" style="width:100%;height:100%; overflow:hidden;" align="center">              
          ...
          <br />
           <table style="display:none; width:90%; height:550px" id="dglista">
              <%
                  string tabla = "";
