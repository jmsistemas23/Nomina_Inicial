<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Consulta_Poliza.aspx.cs" Inherits="FILE_Consultas_Consulta_Poliza" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="Consulta_Poliza.js?1.4"></script>  
</head>
<body>
    <form id="form1" runat="server">     
     <div class="easyui-layout" style="width:100%;height:96%; overflow-x: hidden;overflow-y: scroll;" align="center"> 
        ...
        <table class="easyui-datagrid" id="dgp" >
            ...
            <tr>                        
                ...
                <th data-options="field:'casos',width:70,align:'center',halign:'center'">Casos</th>                              
                <th data-options="field:'descop',width:450,align:'left',halign:'center'">Descripción</th>                              
                <th data-options="field:'importe',width:150,align:'right',halign:'center',
        ...
        <table class="easyui-datagrid" id="dgd" >
            ...
            <tr>                        
                <th data-options="field:'cveind',width:70,align:'center',halign:'center'">Clave</th> 
                <th data-options="field:'casos',width:70,align:'center',halign:'center'">Casos</th>                                                           
                <th data-options="field:'descod',width:450,align:'left',halign:'center'">Descripción</th>                              
                 <th data-options="field:'importe',width:150,align:'right',halign:'center',
                    formatter:function(value, row){return accounting.formatMoney(row.importe);}">Importe</th>  
               <%-- <th data-options="field:'tipmov',width:70,align:'center',halign:'center',hidden:false">Tipo</th>           --%>                   
            </tr>
