...
<%           
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Consulta_BuscarPlazasNomina @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @valor='" + busqueda + "',@orden='" + colord + "'");
