...
public partial class FILE_Consultas_Reporte_Poliza : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            rvReportes.ServerReport.ReportPath = "/" + ds.Tables[0].Rows[0]["rutaReportes"].ToString() + ds.Tables[0].Rows[0]["reportePoliza"].ToString();            
