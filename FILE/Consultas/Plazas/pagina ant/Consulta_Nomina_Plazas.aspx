...
<head runat="server">
    ...
    <script type="text/javascript" src="Consulta_Nomina_Plazas.js?1.9"></script>  
</head>
<body>
      ...
      <table>
          <tr>              
           ...
           <tr>              
              ...
              <td align="left" colspan="3"><input  class="easyui-textbox"  style="width:650px;" id="txtpagaduria" data-options="readonly:true"></input></td>              
          </tr>
          <tr>              
      ...
      <table>
          <tr>
           ...
           <tr>
              ...
              <td align="left"></input><input  class="easyui-textbox"  style="width:100px;" id="txttipopue" data-options="readonly:true"></td>
           ...
           <tr>
              ...
              <td align="left"></input><input  class="easyui-textbox"  style="width:100px;" id="txtbanco" data-options="readonly:true"></td>
           ...
           <tr>
              ...
              <td align="left"><input  class="easyui-textbox"  style="width:150px;" id="txtctaclabe" data-options="readonly:true"></td>
          </tr>
            <tr>
          ...
          <tr>
              ...
              <td align="left"></input><input  class="easyui-textbox"  style="width:200px;" id="txtestatuspag" data-options="readonly:true"></td>
              <td align="left"><asp:Label ID="Label54" CssClass="LetraChicaNegrita" runat="server">Base Grabable Actual:</asp:Label></td>
              <td align="left"><input  class="easyui-textbox"  style="width:100px;" id="txtbasegrab" data-options="readonly:true"></td>
          </tr>
          <tr>
              <td align="left"><asp:Label ID="Label30" CssClass="LetraChicaNegrita" runat="server">Periodo Pag.:</asp:Label></td>
              <td align="left"></input><input  class="easyui-textbox"  style="width:200px;" id="txtperpag" data-options="readonly:true"></td>   
              <td align="left"><asp:Label ID="Label31" CssClass="LetraChicaNegrita" runat="server">Periodo Ret.:</asp:Label></td>
              <td align="left"></input><input  class="easyui-textbox"  style="width:200px;" id="txtperret" data-options="readonly:true"></td>
              <td align="left"><asp:Label ID="Label55" CssClass="LetraChicaNegrita" runat="server">Base Grabable Retro:</asp:Label></td>
              <td align="left"><input  class="easyui-textbox"  style="width:100px;" id="txtbasegrabretro" data-options="readonly:true"></td>
          </tr>
          </table>
