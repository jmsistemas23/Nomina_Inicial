<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Historia_Pagos_Especiales_Plazas.aspx.cs" Inherits="FILE_Consultas_Plazas_Historia_Pagos_Especiales_Plazas" %>
...
<head runat="server">
    ...
    <script src="../../../jqueryEsy/plugins/datagrid-detailview.js"></script>
     <script src="../../../Scripts/jquery-Mask.js"></script>  
    <script type="text/javascript" src="Historia_Pagos_Especiales_Plazas.js?2.1"></script>  
</head>
<body>
    <form id="form1" runat="server">
     <div id="dconfiguracion"  class="easyui-layout" style="width:100%;height:100%;padding:0px;" >           
          <div id="dmenu" class="easyui-layout" style="width:100%; height:100%; padding:0px;" align="Center">
             ...
             <br />             
             <asp:Label ID="Label30" CssClass="LetraChicaNegrita" runat="server">Historia de Movimientos Especiales</asp:Label>  
             <br />
              <table class="easyui-datagrid" id="dghc"  style="width:90%; height:60%;"></table>                 
         </div>
