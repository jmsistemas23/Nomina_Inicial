<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Historia_Pagos_Plazas.aspx.cs" Inherits="FILE_Consultas_Plazas_Historia_Pagos" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="Historia_Pagos_Plazas.js?2.0"></script>  
</head>
<body>
              ...
              <table class="easyui-datagrid" id="dghc"  style="width:90%; height:60%;">
                 <thead>
                   <tr>                        
                       ...
                       <th data-options="field:'viginimc',width:100,align:'center',halign:'center'">Vig. Inicial</th>                  
                       <th data-options="field:'vigfinmc',width:100,align:'center',halign:'center'">Vig. Final</th>                  
                   </tr>
                </thead>         
            </table>                 
         </div>
