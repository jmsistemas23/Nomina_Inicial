<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Consulta_Terceros.aspx.cs" Inherits="FILE_Consultas_Consulta_Terceros" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="Consulta_Terceros.js?1.1"></script>  
</head>
<body>
    ...
    <div class="easyui-layout" style="width:100%;height:100%; overflow:hidden;" align="center"> 
        ...
        <tr>
          ...
          <br />
           <table id="dglista" style="height:550px; width:90%">
              <%
                  string tabla = "ConTerceros";
                  //if (Request.QueryString["tabla"] != null)
                  //{
                  //    tabla = Request.QueryString["tabla"].ToString();
                  //}
                  //else { tabla = "ConTerceros"; }      
                  string[] datos;                
