<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar_Pension.aspx.cs" Inherits="FILE_Consultas_Listar_Pension" %>
...
<%           
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Consulta_BuscarPension @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @valor='" + busqueda + "'");
