<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Consulta_Nomina_Empleados.aspx.cs" Inherits="FILE_Consultas_Empleados_Consulta_Nomina" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="Consulta_Nomina_Empleados.js?1.6"></script>  
    <style type="text/css">
        .auto-style1 {
            height: 26px;
        }
    ...
    <form id="form1" runat="server">
     ...
     <div class="easyui-layout" style="width:100%;height:80%; overflow-x: hidden;overflow-y: scroll;" align="center">        
      <table>
          ...
          <tr>              
              <td align="left"><asp:Label ID="Label6" CssClass="LetraChicaNegrita" runat="server">Est. Prog.:</asp:Label></td>
              <td align="left" colspan="3"><input  class="easyui-textbox"  style="width:550px;" id="txtestprog" data-options="readonly:true"></input></td> 
          </tr>
          <tr>                            
      ...
      <table>
          <tr>
              ...
              <td align="left"><input  class="easyui-textbox"  style="width:200px;" id="txtestatus" data-options="readonly:true"></input></td>   
              ...
              <td align="left"><asp:Label ID="Label10" CssClass="LetraChicaNegrita" runat="server">Quinquenio:</asp:Label></td>
              <td align="left"><input  class="easyui-textbox"  style="width:100px;" id="txtquinquenio" data-options="readonly:true"></td>
          </tr>
           <tr>
              ...
              <td align="left"></input><input  class="easyui-textbox"  style="width:200px;" id="txttipopue" data-options="readonly:true"></td>
              <td align="left"><asp:Label ID="Label13" CssClass="LetraChicaNegrita" runat="server">Nivel Antecedente:</asp:Label></td>
              <td align="left"><input  class="easyui-textbox"  style="width:100px;" id="txtnivant" data-options="readonly:true"></td>
          </tr>
           <tr>
              <td align="left"><asp:Label ID="Label14" CssClass="LetraChicaNegrita" runat="server">Tipo Pago:</asp:Label></td>
              <td align="left"></input><input  class="easyui-textbox"  style="width:200px;" id="txttippago" data-options="readonly:true"></td>   
              <td align="left"><asp:Label ID="Label17" CssClass="LetraChicaNegrita" runat="server">Banco:</asp:Label></td>
              <td align="left"></input><input  class="easyui-textbox"  style="width:200px;" id="txtbanco" data-options="readonly:true"></td>
              <td align="left"><asp:Label ID="Label18" CssClass="LetraChicaNegrita" runat="server">No. Cuenta:</asp:Label></td>
              <td align="left"><input  class="easyui-textbox"  style="width:150px;" id="txtcuenta" data-options="readonly:true"></td>
          </tr>
           <tr>
              <td align="left"><asp:Label ID="Label19" CssClass="LetraChicaNegrita" runat="server">Tipo de Cuenta:</asp:Label></td>
              <td align="left"></input><input  class="easyui-textbox"  style="width:100px;" id="txttipocta" data-options="readonly:true"></td>   
              <td align="left"><asp:Label ID="Label20" CssClass="LetraChicaNegrita" runat="server">Sucursal:</asp:Label></td>
              <td align="left"></input><input  class="easyui-textbox"  style="width:100px;" id="txtsucursal" data-options="readonly:true"></td>
              <td align="left"><asp:Label ID="Label21" CssClass="LetraChicaNegrita" runat="server">Cta. Clabe:</asp:Label></td>
              <td align="left"><input  class="easyui-textbox"  style="width:100px;" id="txtctaclabe" data-options="readonly:true"></td>
          </tr>
            <tr>
              <td align="left"><asp:Label ID="Label22" CssClass="LetraChicaNegrita" runat="server">Días de Pago:</asp:Label></td>
              <td align="left"></input><input  class="easyui-textbox"  style="width:100px;" id="txtdiaspago" data-options="readonly:true"></td>   
              <td align="left"><asp:Label ID="Label23" CssClass="LetraChicaNegrita" runat="server">Días de Retro:</asp:Label></td>
              <td align="left"></input><input  class="easyui-textbox"  style="width:100px;" id="txtdiasretro" data-options="readonly:true"></td>
              <td align="left"><asp:Label ID="Label27" CssClass="LetraChicaNegrita" runat="server">N.S.S.:</asp:Label></td>
              <td align="left"><input  class="easyui-textbox"  style="width:100px;" id="txtnss" data-options="readonly:true"></td>
          </tr>
           <tr>
              ...
              <td align="left"><asp:Label ID="Label25" CssClass="LetraChicaNegrita" runat="server">No. Cheque:</asp:Label></td>
              <td align="left"></input><input  class="easyui-textbox"  style="width:100px;" id="txtcheque" data-options="readonly:true"></td>
              <td align="left">&nbsp;</td>
              <td align="left">&nbsp;</td>
          </tr>
          <tr>
              <td align="left"><asp:Label ID="Label28" CssClass="LetraChicaNegrita" runat="server">Grupo Jer.:</asp:Label></td>
              <td align="left"></input><input  class="easyui-textbox"  style="width:200px;" id="txtgpojer" data-options="readonly:true"></td>   
              <td align="left"><asp:Label ID="Label29" CssClass="LetraChicaNegrita" runat="server">Estatus Pago:</asp:Label></td>
              <td align="left"></input><input  class="easyui-textbox"  style="width:100px;" id="txtestatuspag" data-options="readonly:true"></td>
              <td align="left"><asp:Label ID="Label26" CssClass="LetraChicaNegrita" runat="server">Base Grabable Actual:</asp:Label></td>
              <td align="left"><input  class="easyui-textbox"  style="width:100px;" id="txtbasegrab" data-options="readonly:true"></td>
          </tr>
          <tr>
              <td align="left" class="auto-style1"><asp:Label ID="Label30" CssClass="LetraChicaNegrita" runat="server">Periodo Pag.:</asp:Label></td>
              <td align="left" class="auto-style1"></input><input  class="easyui-textbox"  style="width:200px;" id="txtperpag" data-options="readonly:true"></td>   
              <td align="left" class="auto-style1"><asp:Label ID="Label31" CssClass="LetraChicaNegrita" runat="server">Periodo Ret.:</asp:Label></td>
              <td align="left" class="auto-style1"></input><input  class="easyui-textbox"  style="width:200px;" id="txtperret" data-options="readonly:true"></td>
              <td align="left" class="auto-style1"><asp:Label ID="Label39" CssClass="LetraChicaNegrita" runat="server">Base Grabable Retro:</asp:Label></td>
              <td align="left" class="auto-style1"><input  class="easyui-textbox"  style="width:100px;" id="txtbasegrabretro" data-options="readonly:true"></td>
          </tr>
          </table>
