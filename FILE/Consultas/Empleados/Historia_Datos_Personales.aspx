<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Historia_Datos_Personales.aspx.cs" Inherits="FILE_Consultas_Empleados_Historia_Datos_Personales" %>
...
<head runat="server">
    ...
    <script src="Historia_Datos_Personales.js?1.2"></script>
</head>
<body>
    <form id="form1" runat="server">
     <div id="dconfiguracion"  class="easyui-layout" style="width:100%;height:100%;padding:0px;" >           
         <div id="dmenu" class="easyui-layout" style="width:100%; height:100%; padding:0px;" align="Center">
             ...
             <br />             
             <asp:Label ID="Label30" CssClass="LetraChicaNegrita" runat="server">Historia de Datos Personales</asp:Label>  
             <br />
