<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Historia_Terceros_Empleados.aspx.cs" Inherits="FILE_Consultas_Empleados_Historia_Terceros_Empleados" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="Historia_Terceros_Empleados.js?1.0"></script>  
</head>
<body>
    ...
    <div id="dconfiguracion"  class="easyui-layout" style="width:100%;height:100%;padding:0px;" >           
       <div id="dmenu" class="easyui-layout" style="width:100%; height:100%; padding:0px;" align="Center">
             ...
             <br />             
             <asp:Label ID="Label30" CssClass="LetraChicaNegrita" runat="server">Historia de Terceros</asp:Label>  
             <br />
             <table class="easyui-datagrid" id="dght"  style="width:90%; height:60%">
                 <thead>
                   <tr>                        
                       <th data-options="field:'indicador',width:90,align:'center',halign:'center'">Indicador</th>                              
                       <th data-options="field:'desind',width:200,align:'left',halign:'center'">Descripción</th>                              
                       <th data-options="field:'importe',width:90,align:'right',halign:'center'">Importe</th>                                         
                       <th data-options="field:'contador',width:90,align:'center',halign:'center'">Contador</th>                  
                       <th data-options="field:'periodo',width:90,align:'center',halign:'center'">Periodo</th>                  
                       <th data-options="field:'quin',width:90,align:'center',halign:'center'">Quincena</th>                  
                       <th data-options="field:'año',width:90,align:'center',halign:'center'">Año</th>                                         
                   </tr>
                </thead>         
            </table>                  
         </div> 
