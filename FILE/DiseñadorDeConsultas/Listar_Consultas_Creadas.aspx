<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar_Consultas_Creadas.aspx.cs" Inherits="FILE_DiseñadorDeConsultas_Listar_Consultas_Creadas" %>
...
<%        
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Consultas_Listar_ConsultasCreadas @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @valor='" + busqueda + "'");
