<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar_Procesos.aspx.cs" Inherits="FILE_Calculo_Listar_Procesos" %>
...
<%        
    ...
    //System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_CalculoPerfiles_ListarProcesosCalculo @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @condicion='" + busqueda + "'");
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_CalculoPerfiles_ListarProcesosCalculo @condicion='" + busqueda + "'");
