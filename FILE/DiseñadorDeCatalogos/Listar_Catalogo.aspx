<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar_Catalogo.aspx.cs" Inherits="FILE_DiseñadorDeCatalogos_Listar_Catalogo" %>
...
<%        
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Catalogos_Listar_DatosCatalogo @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "',@tabla="+tabla+",@campo='"+campo+"', @busqueda='" + busqueda + "'");
