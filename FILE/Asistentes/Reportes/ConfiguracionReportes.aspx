<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConfiguracionReportes.aspx.cs" Inherits="FILE_Asistentes_ConfiguracionReportes" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="../../../scripts/Funsiones.js"></script> 
     <script type="text/javascript" src="ConfiguracionReportes.js?1.4"></script>    
</head>
<body>
    ...
    <div class="easyui-layout" style="width:100%;height:100%; overflow:hidden;" align="center"> 
         <div class="easyui-panel" style="padding:3px; width:100%">                                    
                 ...
                 <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-no'" id="btnEliminar" >Eliminar Elemento</a>                              
            ...
            <div id="p" data-options="region:'west'" style="width:30%;padding:0px; overflow:hidden;" align="center">
                <div class="easyui-layout" style="width:100%;height:100%; overflow:hidden;">
                    <div data-options="region:'north'" style="width:100%; height:9%; padding:5px; overflow:hidden;" align="center"> 
                        <asp:Label ID="Label13" CssClass="LetraChicaNegrita" runat="server" Text="Lista De Reportes"></asp:Label> 
                ...
                <table style="margin-top:30px;">                   
                    <tr>
                       ...
                       <td align="left"><input class="easyui-textbox" style="width:50px" id="txtpropietario" data-options="readonly:true">
                           <input class="easyui-textbox" style="width:450px" id="txtNomPropietario" data-options="readonly:true"><a id="btnNuevoPropietario" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true" style="width: 80px">Cambiar</a></td>
                    </tr>                    
                     <tr>
                        <td align="left"> <asp:Label ID="Label16" CssClass="LetraChicaNegrita" runat="server">Descripción del Reporte:</asp:Label></td>
                       <td align="left"><input class="easyui-textbox" style="width:50px" id="txtId" data-options="readonly:true"><input class="easyui-textbox" style="width:450px" id="txtdescripcion"></td>
                    </tr>
                     <tr>
                        <td align="left"> <asp:Label ID="Label3" CssClass="LetraChicaNegrita" runat="server">Nombre del Reporte:</asp:Label></td>
                       <td align="left"><input class="easyui-textbox" style="width:500px" id="txtreporte"></td>
                    </tr>
                     <tr>
                ...
                <div title="Empleados" style="overflow:auto;padding:5px;" align="center">               
                      <table class="easyui-datagrid" id="dg"  style="width:90%; height:auto">
                        ...
                        <tr>                        
                            ...
                            <th data-options="field:'descripcion',width:370,align:'left',halign:'center'">Descripcion</th>        
                            <th data-options="field:'nomreporte',width:370,align:'left',halign:'center'">Reporte</th>                                                    
    ...
    <div id="modalPropietarios" class="easyui-window" title="Seleccione Nuevo Nivel" data-options="modal:true,minimizable:false,collapsible:false,maximizable:false,closed:true,iconCls:'icon-search'" style="width: 450px; height: 650px; padding: 10px;">
       <div id="divGridConceptos" align="center" style="width: 100%;">
         <a id="btnCancelarPropietario" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-back'" style="width: 160px">Cancelar</a><br> <br>
      </div>        
