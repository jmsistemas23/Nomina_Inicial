<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar_SubReportes.aspx.cs" Inherits="FILE_Asistentes_Listar_SubReportes" %>
...
<%           
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Sistemas_ListarSubReportes @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @valor='" + busqueda + "'");
