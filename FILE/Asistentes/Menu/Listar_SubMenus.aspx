<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar_SubMenus.aspx.cs" Inherits="FILE_Asistentes_Listar_SubMenus" %>
...
<%           
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Sistemas_ListarSubMenus @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @valor='" + busqueda + "'");
