<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar_SubMovimientos.aspx.cs" Inherits="FILE_Asistentes_Listar_MovimientosMP" %>
...
<%           
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Sistemas_ListarSubMovimientos @tipo='" + tipo + "',@desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @valor='" + busqueda + "'");
