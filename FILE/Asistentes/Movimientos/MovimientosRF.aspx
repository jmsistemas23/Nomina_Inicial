<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MovimientosRF.aspx.cs" Inherits="FILE_Asistentes_MovimientosRF" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="../../../scripts/Funsiones.js"></script> 
     <script type="text/javascript" src="MovimientosRF.js?1.0"></script>    
</head>
<body>
