<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar_Empleados.aspx.cs" Inherits="FILE_Consultas_Listar_Empleados" %>
...
<%           
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Cancelaciones_BuscarEmpleados @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @valor='" + busqueda + "',@quincena='"+quincena+"'");
