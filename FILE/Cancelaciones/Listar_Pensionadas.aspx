<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar_Pensionadas.aspx.cs" Inherits="FILE_Cancelaciones_Listar_Pensionadas" %>
...
<%           
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Cancelaciones_BuscarPension @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @valor='" + busqueda + "',@quincena='" + quincena + "'");
