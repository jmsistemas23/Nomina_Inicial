...
<%
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("select count(*) from estrupro where cveestpr like '%" + busqueda + "%' or desestpr like '%" + busqueda + "%' ");
    ...
    ds = lib.ejecutarConsultaEnDataSet("GESRH_SP_SelectParaPaginacionDeEstPro @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @busqueda='" + busqueda + "'");
