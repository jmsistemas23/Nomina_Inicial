...
$(document).ready(function () {
    ...
    } else { desperfil = 'Bono de Puntualidad'; }
    ...
    $('#btnRegresar').bind('click', function () {
        document.location = "Diseñador_Filtros.aspx";
        IR_PAGINA("Diseñador_Filtros.aspx", "");
    });
    ...
    $('#btnActualizarVista').bind('click', function () { VISTA_PREVIA(); });
    ...
    function ACEPTAR_DISEÑO_CONSULTA(btnobj) {
        ...
        else
        {
            ...
            else
            {
                ...
                //        }
                //    });
                //    $('#dgcolumnas').datagrid('beginEdit', total);
                //    var edorden = $('#dgcolumnas').datagrid('getEditor', { index: total, field: 'Orden' })
                //    $(edorden.target).textbox('textbox').css('textAlign', 'center')
                //    var OrdVista = $(dgobj).datagrid('getEditor', { index: total, field: 'OrdVista' })
                //    $(OrdVista.target).textbox('textbox').css('textAlign', 'center')
                //    var OrdProceso = $(dgobj).datagrid('getEditor', { index: total, field: 'OrdProceso' })
                //    $(OrdProceso.target).textbox('textbox').css('textAlign', 'center')
                //}
