<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Diseñador_Consulta.aspx.cs" Inherits="FILE_ProcesoEspecial_Perfiles_Diseñador_Consulta" %>
...
<head runat="server">
    ...
    <script src="Diseñador_Consultas.js?2.2"></script>
                                ...
                                <div title="Diseño del Proceso" style="border-style: none; padding: 3px; overflow:hidden; width:100%" align="center">
                                    ...
                                    <thead>
                                        <tr>                                                                                              
                                          ...
                                          <%--  <th data-options="field:'Vista',width:70,align:'center', editor:{type:'checkbox',options:{on:'1',off:''}}">Vista</th>
                                            <th data-options="field:'OrdVista',width:80,align:'center',halign:'center', editor: { type: 'textbox'}">Ord. Vista</th>--%>  
                                            <%--<th data-options="field:'Proceso',width:70,align:'center', editor:{type:'checkbox',options:{on:'1',off:''}}">Proceso</th>
                                            <th data-options="field:'OrdProceso',width:80,align:'center',halign:'center', editor: { type: 'textbox'}">Ord. Proceso</th>  --%>
                                    ...
                                    <div id="tbcol" style="padding:3px; width:100%">   
                                        ...
                                        <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-save',disabled:false" id="btnGuardarProceso">Guardar Proceso</a>
                                    </div>      
                                </div>   
