<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bloquear_Cancelación.aspx.cs" Inherits="FILE_Bloqueos_Bloquear_Cancelación" %>
...
<head runat="server">
    ...
    <script src="Bloquear_Cancelaciones.js?1.0"></script>
</head>
<body>
    <form id="form1" runat="server">
     <div id="dconfiguracion"  class="easyui-layout" style="width:100%;height:100%;padding:0px;" align="Center">   
         ...
         <table style="width: 100%;">
                <tr>
                    <td align="Center">
                        <asp:Label ID="lbltitulo" CssClass="TituloMedio" runat="server" Text="Cancelación de Pago"></asp:Label><br>
                    </td>
                </tr>                
            </table>  
             <br />         
             <table style="width: 100%;">           
                <tr>
                    <td align="Center">                    
                        <a id="btnDesbloqueo" href="#" class="easyui-linkbutton" data-options="plain:false,iconCls:'Desbloqueo',size:'large',iconAlign:'top' ,toggle:true,group:'q'" style="width:150px;height:100px; font-weight: bold; font-size: x-large;">Desbloquear</a>                                                   
                        <a id="btnBloqueo" href="#" class="easyui-linkbutton" data-options="plain:false,iconCls:'Bloqueo',size:'large',iconAlign:'top', toggle:true,group:'q'" style="width:150px; height:100px; font-weight: bold; font-size: x-large;" >Bloquear</a>
                    </td>
                </tr>                        
            </table> 
        <%--  <br /> 
