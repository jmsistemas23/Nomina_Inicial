<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cat_Perfiles_Excel.aspx.cs" Inherits="FILE_Cargar_Excel_Cat_Perfiles_Excel" %>
...
<head runat="server">
    ...
    <script src="Cat_Perfiles_Excel.js"></script>
</head>
<body>
         ...
         <table id="dglista"> 
                  <thead>
                    <tr>                        
                        ...
                        <th data-options="field:'procedimiento',width:300,align:'left',halign:'center'">Procedimiento</th>  
    ...
    <div id="dcaptura" style="width:100%;height:100%;padding:0px; display:none" align="Center">                 
         ...
         <br />
            <table>
                ...
                <tr>
                    <td align="left"><asp:Label ID="Label4" CssClass="LetraChicaNegrita" runat="server">Procedimiento:</asp:Label></td>
                    <td align="left"><input  class="easyui-textbox"  style="width:300px;" id="txtprocedimiento"  value=""></input></td> 
                </tr>
                <tr>
