...
using System.IO;
public partial class FILE_Cargar_Excel_Diseñador_Perfil_Excel : System.Web.UI.Page
{
    ...
    protected void btnCargarArchivo_Click(object sender, EventArgs e)
    {
        if (cargaArchivo.HasFile)
        {
            ...
            ClientScript.RegisterStartupScript(GetType(), "Javascript", "javascript:CARGAR_NUEVO_PERFIL('" + columnas + "','Si');", true);
        }
        else { ClientScript.RegisterStartupScript(GetType(), "Javascript", "javascript:CARGAR_NUEVO_PERFIL('','No');", true); }
    }
