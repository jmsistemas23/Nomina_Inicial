...
<%
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SP_Costeo_Listar_CentroCosto @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @busqueda='" + busqueda + "',@filtro='" + filtro + "'");
