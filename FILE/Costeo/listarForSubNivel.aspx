...
<%
    ...
    ds = lib.ejecutarConsultaEnDataSet("GESRH_SP_Costeo_Listar_ColumnasNivelSalarial @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @codNiv = '" + nivel + "',@busqueda='" + busqueda + "'");
