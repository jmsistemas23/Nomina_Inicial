    ...
    <form id="form1" runat="server">
     <div id="ddiseño" style="border-style: none; width:100%;height:100%; overflow:hidden;" align="Center">              
         <div class="easyui-panel" style="padding:3px; width:100%">    
             ...
             <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon_excel',disabled:true" id="btnExcel">Exportar Excel</a>                 
        </div>
        <br />   
         ...
         <br />         
         <table id="dgcalendario" class="easyui-datagrid"  style="width:90%; height:15%;" data-options = "striped: true,fitColumns:false,rownumbers: true, pagination: false, singleSelect: true, autoRowHeight: false "> 
              <thead>
                  <tr>                      
