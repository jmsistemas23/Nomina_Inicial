...
<head id="Head1" runat="server">
    ...
    <script src="Proyeccion.js?1.1"></script>
     <style type="text/css"> 
        .icon-layout{
...
<body>
    <form id="form1" runat="server">
      <div id="ddiseño" style="border-style: none; width:100%;height:100%; overflow:hidden;" align="Center">                     
             ...
             <div class="easyui-accordion" style="width:100%;height:40%; overflow:hidden"> 
                 ...
                 <div title="Adicionales" style="overflow:hidden;  padding:5px;" align="center">       
                       <table>
                         ...
                         <tr>
                            <td align="left"><asp:Label ID="Label40"  CssClass="LetraChicaNegrita" runat="server" Text="Titulación:"></asp:Label></td>                                        
                            <td align="left">
                                <asp:RadioButton ID="rbTitulasi" runat="server" Text="Si" CssClass="LetraChicaNegrita" GroupName="titula" Checked="True"/>
                                <asp:RadioButton ID="rbTitulano" runat="server" Text="No" CssClass="LetraChicaNegrita"  GroupName="titula" />
                             </td>
                            <td align="left">&nbsp;</td>
                            <td align="left">&nbsp;</td>
                        </tr>                  
                         <tr>
                          ...
                          <tr>
                            ...
                            <td align="left" colspan="3">
                                <asp:RadioButton ID="rbsi" runat="server" Text="Si" CssClass="LetraChicaNegrita" GroupName="padomad" />
                                <asp:RadioButton ID="rbno" runat="server" Text="No" CssClass="LetraChicaNegrita"  GroupName="padomad" Checked="True"/>
                              </td>
                        </tr>                                        
                          <tr>
                   ...
                   <table id="dgfiltro" class="easyui-datagrid"  style="width:60%; height:35%;"  toolbar="#tbt" data-options="rownumbers: true,singleSelect:true, striped:true">
                     <thead>
                        <tr>   
                            ...
                            <th data-options="field:'titulacion',width:100,align:'center',halign:'center',hidden: false">Titulación</th>
        ...
        <div id="modalBuscarSubNivel" align="center" title="Buscar Sub Nivel del Puesto" class="easyui-dialog" style=" overflow:hidden;width:50%;height:643px;padding:3px; background-image: url('../../Imagenes/FONDO1.jpg');" closed="true" data-options="iconCls:'icon-search',resizable:false,modal:true">             
              <table>                    
                     <tr>
                       <td align="Center">
