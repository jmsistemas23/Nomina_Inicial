    ...
    <form id="form1" runat="server">
      <div id="ddiseño" style="border-style: none; width:100%;height:100%; overflow:hidden;" align="Center">                     
        ...
        <div id="modalBuscarEstatusPla" title="Buscar Estatus de la Plaza" class="easyui-dialog" align="center" style="width:740px;height:643px;padding:0px; background-image: url('../../Imagenes/FONDO1.jpg');" closed="true" data-options="iconCls:'icon-search',resizable:false,modal:true">      
          ...
          <div id="modalBuscarPuesto" align="center" class="easyui-dialog" style="width:740px;height:643px;padding:0px; background-image: url('../../Imagenes/FONDO1.jpg');"  closed="true" title="Buscar Puesto" data-options="iconCls:'icon-search',resizable:false,modal:true">       
              <div class="easyui-panel" style="padding:3px; width:100%">                                            
        ...
        <div id="modalBuscarSubNivel" align="center" title="Buscar Sub Nivel del Puesto" class="easyui-dialog" style="width:740px;height:643px;padding:0px; background-image: url('../../Imagenes/FONDO1.jpg');" closed="true" data-options="iconCls:'icon-search',resizable:false,modal:true">             
              <table>                    
                     <tr>
                       <td align="Center">
         ...
         <div class="easyui-dialog" style="width:740px;height:600px;padding:0px; background-image: url('../../Imagenes/FONDO1.jpg'); overflow:hidden;"  id="wind" closed="true" align="center">  
              <div class="easyui-panel" style="padding:3px; width:100%">                                            
