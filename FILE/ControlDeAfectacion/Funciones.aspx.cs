...
public partial class FILE_CatalogosGenerales_funsiones_catgen : System.Web.UI.Page
{
    ...
    [WebMethod(EnableSession = true)]
    [ScriptMethod]
    public static string[] Diseño_Cat(string modulo,string tipo,string condicion, string multi)
    {
        string[] result = { "", "", "" };
        Utilerias lib = new Utilerias();
        DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Sistemas_CifrasControl '" + modulo + "','"+tipo+"','"+condicion+"','"+multi+"'");
        //if (ds.Tables[0].Rows.Count > 0)
        //{
            //datos
