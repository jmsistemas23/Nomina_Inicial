...
<%
    ...
    ds = lib.ejecutarConsultaEnDataSet("[GESRH_SP_SelectParaPaginacionDeCentroCosto] @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @busqueda='" + busqueda + "',@tipoplaza='"+tipoplaza+"'");
