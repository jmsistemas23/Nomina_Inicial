...
<%
    ...
    System.Data.DataTable ds = lib.ejecutarConsultaEnDataTable("GESRH_SP_SelectParaPaginacionDeForNivel @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @columnas='" + columnas + "', @codNiv = '" + nivel + "',@codzon='" + zona + "'");

    if (ds.Rows.Count > 0)
    { totRegs = ds.Rows[0][0].ToString(); }
    else { totRegs = "0"; }
