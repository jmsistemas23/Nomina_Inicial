<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListarPrograma.aspx.cs" Inherits="FILE_CreacionDePlazas_Org_ListarPrograma" %>
...
<%
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SP_SelectParaPaginacionDePrograma @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @busqueda='" + busqueda + "'");
