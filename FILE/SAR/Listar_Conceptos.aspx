<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar_Conceptos.aspx.cs" Inherits="FILE_SAR_Listar_Conceptos" %>
...
<%        
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_SAR_ListarConceptos @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @valor='" + busqueda + "'");
