...
<%
    ...
    //System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Capturas_DatosGrid @tipo='"+tipo+"',@tabla='" + tabla + "',@campo='" + campo + "',@mov='" + mov + "', @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @condicion='" + busqueda + "',@pagina="+pagina);
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Capturas_Listar_Catalogo @tipo='" + tipo +"',@mov='" + mov +"',@campo='" + campo + "',@desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @condicion='" + busqueda + "',@pagina=" + pagina);
