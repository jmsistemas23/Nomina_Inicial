<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reporteador.aspx.cs" Inherits="FILE_Impresion_Formatos_Reporteador" %>
    ...
    <form id="form1" runat="server">
     <div id="dconfiguracion"  class="easyui-layout" style="width:100%;height:100%;padding:0px; overflow-x:hidden; overflow-y:hidden;" align="Center">
        ...
        <div class="easyui-layout" style="width:100%;height:97%;  overflow-x:hidden; overflow-y:hidden;">        
             <div id="p" data-options="region:'west',split:true,hideCollapsedContent:false,collapsed:false" title="Reportes" style="width:20%; height:100%; overflow:hidden;" align="center">
                 <div id="Div6" class="easyui-panel" style="width:100%;height:100%; background-color: #FFFFFF; overflow-x:scroll; overflow-y:scroll;">                     
                     <asp:TreeView ID="treportes" runat="server"  Width="100%" OnSelectedNodeChanged="treportes_SelectedNodeChanged" ForeColor="#663300"></asp:TreeView>
                 </div> 
            </div>
            <div data-options="region:'center'" style="width:80%; Height:100%; padding:0px; overflow-x:hidden; overflow-y:hidden; background-color: #FFFFFF;" align="center">                                                   
                <div style="width:100%; Height:100%; padding:0px; overflow-x:scroll; overflow-y:scroll;">
