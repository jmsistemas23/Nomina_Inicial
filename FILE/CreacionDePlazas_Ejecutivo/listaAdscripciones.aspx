<%@ Page Language="C#" AutoEventWireup="true" CodeFile="listaAdscripciones.aspx.cs" Inherits="creacionDePlazas_listaAdscripciones" %>
...
<%
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("select count(*) from adscri where cveads like '%" + busqueda + "%' or desads like '%" + busqueda + "%' ");
    ...
    ds = lib.ejecutarConsultaEnDataSet("[GESRH_SP_SelectParaPaginacionDeCentroCosto] @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @busqueda='" + busqueda + "'");
