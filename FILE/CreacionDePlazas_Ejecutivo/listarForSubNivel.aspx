...
<%
    ...
    ds = lib.ejecutarConsultaEnDataSet("GESRH_SP_SelectParaPaginacionDeForNivel @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @columnas='" + columnas + "', @codNiv = '" + nivel + "',@codzon='" + zona + "'");
