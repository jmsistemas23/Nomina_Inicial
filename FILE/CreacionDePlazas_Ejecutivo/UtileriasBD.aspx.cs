...
public partial class creacionDePlazas_UtileriasBD : System.Web.UI.Page
{
    ...
    [WebMethod(EnableSession = true)]
    [ScriptMethod]
    public static string Lista_TipoVacantes(string tipo)
    {
        Utilerias lib = new Utilerias();
        List<campoDeCatalogoClaveString> lstNominas = new List<campoDeCatalogoClaveString>();
        ...
        DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SP_CreacionPlaza_Lista_Vacantes '"+tipo+"'");
        for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
        {
            campo = new campoDeCatalogoClaveString();
    ...
    public static string[] listarSubNivSal(string codniv,string cvezon)
    {
        Utilerias lib = new Utilerias();
        string[] result = { "", "" };
        DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SP_CreacionPlaza_Listar_Subnivel '" + codniv + "','" + cvezon + "'");
    ...
    [WebMethod(EnableSession = true)]
    [ScriptMethod]
    public static string[] Listar_CreacionPlazas()
    {
        string[] result = { "", "", "" };
        Utilerias lib = new Utilerias();
        JavaScriptSerializer js = new JavaScriptSerializer();
        ...
        DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Sistemas_ListarCreacionPlaza " + idusuario + ",'I'");
