<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Creacion_Plazas_Ejecutivo.aspx.cs" Inherits="FILE_CreacionDePlazas_Ejecutivo_Creacion_Plazas_Ejecutivo" %>
...
<head runat="server">
    ...
    <script src="../../Scripts/jquery-Mask.js"></script>  
     <script type="text/javascript" src="CreacionPlazasEjecutivo.js?2.7"></script>
    <style type="text/css">
        .auto-style1 {
        }
        </style>
    ...
    <div class="easyui-layout" style="width:100%;height:100%; overflow:hidden;" align="center"> 
      <div id="dmenu" style="width:100%; height:100%; padding:2px; " align="Center">                                                                               
          ...
          <table style="width: 100%;">
                <tr>
                    <td align="Center">
                        <asp:Label ID="lbltitulo" CssClass="TituloMedio" runat="server" Text="Creacion de plazas"></asp:Label>
                    </td>
                    <td align="Center">
                        <asp:Label ID="lblmensaje" CssClass="TituloMedio" style="display:none" runat="server" Text="No se cuenta con permisos para la CREACION DE PLAZAS"></asp:Label><br>
                    </td>
                </tr>                
            </table>
          <br />
       <%--  <div class="easyui-panel" style="width:50%; margin-top:20px;  padding:4px" align="Center" id="dbotones">                        --%>
           <table style="width: 100%;">           
              <tr>
                  <td align="Center">
                        <a id="aNormal" href="#" class="easyui-linkbutton" data-options="plain:false,iconCls:'empleados',size:'large',iconAlign:'top'" style="width:150px;height:80px; font-weight: bold;font-size: x-large;" >Normal</a>
                        <a id="aInterinas" href="#" class="easyui-linkbutton" data-options="plain:false,iconCls:'sustitutos',size:'large',iconAlign:'top'" style="width:150px;height:80px; font-weight: bold;font-size: x-large;" >Interinos</a>
                       <%-- <a id="aHonorarios" href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'honorarios',size:'large',iconAlign:'top'" style="width:100px" >Honorarios</a>--%>
                        <a id="aJubilados" href="#" class="easyui-linkbutton" data-options="plain:false,iconCls:'jubilados',size:'large',iconAlign:'top'" style="width:150px;height:80px; font-weight: bold;font-size: x-large;" >Jubilados/Pensionados</a>
                        <a id="aNoEmpleados" href="#" class="easyui-linkbutton" data-options="plain:false,iconCls:'noempleados',size:'large',iconAlign:'top'" style="width:150px;height:80px; font-weight: bold;font-size: x-large;" >No Empleados</a>                                         
                  </td>
              </tr>                        
        </table>                  
       <%--  </div>        --%>  
      ...
      <div id="dinicial" style="width:100%; height:100%; padding:0px; display:none" align="Center">              
          ...
          <table style="border-spacing: 7px">
                <tr>
                    <td align="left"><asp:Label ID="Label2"  CssClass="LetraChicaNegrita" runat="server" Text="No. de Plaza a Crear:"></asp:Label></td>
          ...
          <table style="border-spacing: 7px">               
            ...
            <tr>
               ...
               <%-- <td align="left" colspan="5"><asp:Label ID="Label22"  CssClass="LetraChicaNegrita" runat="server" Text="Hora/Jornada:"></asp:Label>
                    <input id="txthora" class="easyui-textbox " value="0" data-options="readonly:true" style="width:80px" >&nbsp; <asp:Label ID="Label33"  CssClass="LetraChicaNegrita" runat="server" Text="No. Horas:"></asp:Label>
                    <input id="txthoras" class="easyui-textbox " value="0" data-options="readonly:false" style="width:80px" ></td>              --%>                          
      ...
      <div id="modalBuscarPuesto" align="center" class="easyui-dialog" style="width:70%;height:642px;padding:3px; background-image: url('../../Imagenes/FONDO1.jpg');"  closed="true" title="Buscar Puesto" data-options="iconCls:'icon-search',resizable:false,modal:true">       
          <table>
            <tr>
      ...
      <div id="modalBuscarSubNivel" align="center" title="Buscar Sub Nivel del Puesto" class="easyui-dialog" style="width:70%;height:600px;padding:3px; background-image: url('../../Imagenes/FONDO1.jpg');" closed="true" data-options="iconCls:'icon-search',resizable:false,modal:true">      
        <table>
           ...
           <table class="easyui-datagrid" id="tblBusquedaDeForSubNivel" style="height:95%;width:100%;" > 
               <thead data-options="frozen:true">
                   <tr>
      ...
      <div id="modalBuscarCentroCosto" title="Buscar Unidad Responsable" class="easyui-dialog" align="center" style="width:740px;height:643px;padding:3px; background-image: url('../../Imagenes/FONDO1.jpg');" closed="true" data-options="iconCls:'icon-search',resizable:false,modal:true">      
          <table>
               <tr>
            ...
            <table class="easyui-datagrid" id="tblBusquedaDeCentroCosto" style="width:100%; height:570px;"> 
                   <thead>
                   <tr>
                       <th data-options="field:'Clave'">Clave</th>
                       <th data-options="field:'Descripcion'">Descripción</th>                                     
        ...
        <form id="Form5" method="post" novalidate>
           ...
           <table class="easyui-datagrid" id="tblBusquedaDePagaduria" style="width:100%; height:570px;"> 
                   ...
                   <tr>
                        <th data-options="field:'Clave'">Clave</th>
                        <th data-options="field:'Descripcion'">Descripción</th>                          
                        <th data-options="field:'Municipio'">Municipio</th>
      ...
      <div id="modalBuscarForISR" title="Buscar ISR" class="easyui-dialog"  align="center" style="width:550px;height:230px;padding:3px; background-image: url('../../Imagenes/FONDO1.jpg');" closed="true" data-options="iconCls:'icon-search',resizable:false,modal:true">        
             <table>
                <tr>
           ...
           <table class="easyui-datagrid" id="tblBusquedaDeForISR" style="width:100%;"> 
                   <thead>
                   <tr>
                        <th data-options="field:'Clave'">Clave</th>
                        <th data-options="field:'Descripcion'">Descripción</th>                        
