...
<%    
    ...
    ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Catalogos_DatosGrid @tabla='" + tabla + "', @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @condicion='" + busqueda + "',@multi='"+multi+"'"); 
