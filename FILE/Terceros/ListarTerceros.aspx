<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListarTerceros.aspx.cs" Inherits="FILE_Terceros_ListarTerceros" %>
...
<%       
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_CapturaTerceros_ListarMovimientosTerceros @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @valor='" + busqueda + "'");
