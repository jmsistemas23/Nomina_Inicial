<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listar_Campos.aspx.cs" Inherits="FILE_Terceros_Listar_Campos" %>
...
<%    
    ...
    System.Data.DataSet ds = lib.ejecutarConsultaEnDataSet("GESRH_SPT_Terceros_ListaCampos @desde='" + ((paginasN * rowsN) - rowsN + 1).ToString() + "', @hasta='" + (paginasN * rowsN).ToString() + "', @valor='" + busqueda + "'");
